...
\begin{table}[htbp]
    ...
    \makebox[\textwidth][c]{
        \begin{tabular}{c|r|cl}
            \multicolumn{4}{l}{\textbf{\fixed{: times14}} ( $n_1$ --- $n_2$ ), \ $n_2 = 14 * n_1$} \\
            \toprule
            Step & Data Stack         & Interpret & Description \\ \hline
            1    & $n_1$              & 2         &  \\
            2    & $n_1$ \ 2          & 3         &  \\
            3    & $n_1$ \ 2 \ 3      & 4         &  \\
            4    & $n_1$ \ 2 \ 3 \ 4  & +         & ($n_1$ $n_2$ --- $n_3$), \ $n_3 = n_1 + n_2$ \\
            5    & $n_1$ \ 2 \ 7      & *         & ($n_1$ $n_2$ --- $n_3$), \ $n_3 = n_1 * n_2$ \\
            6    & $n_1$ \ 14         & *         & ($n_1$ $n_2$ --- $n_3$), \ $n_3 = n_1 * n_2$ \\
            7    & $n_2$              & ;         & Return to interpreter \\
            \bottomrule
        \end{tabular}%
    }
    \label{tab:addlabel}%
